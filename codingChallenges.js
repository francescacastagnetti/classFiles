...
let scorePandas = (96 + 108 + 89) / 3;
let scoreKoalas = (88 + 91 + 110) / 3;
console.log("Pandas Average Score:", scorePandas, "\nKoalas Average Score:", scoreKoalas);
...
console.log("TEST DATA BONUS #1");
  ...
  let koalasScoreArray = [109, 95, 123];
  scoreKoalas = avgScore(koalasScoreArray);
  console.log("Pandas Average Score:", scorePandas, "\nKoalas Average Score:", scoreKoalas);
  ...
  pandasScoreArray = [97, 112, 101];
  scorePandas = avgScore(pandasScoreArray);
  koalasScoreArray = [109, 95, 106];
  scoreKoalas = avgScore(koalasScoreArray);
